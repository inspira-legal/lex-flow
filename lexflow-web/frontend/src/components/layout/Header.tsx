  ...
  return (
    <header className={styles.header}>
      <div className={styles.left}>
        ...
        <button className={styles.iconBtn} onClick={handleNew} title="New Workflow">
          <FileIcon />
        </button>
        <button className={styles.iconBtn} onClick={handleImport} title="Import Workflow">
          <UploadIcon />
        </button>
        <button className={styles.iconBtn} onClick={handleExport} title="Export Workflow">
          <DownloadIcon />
        </button>
        <div className={styles.divider} />
        <button
        ...
        <div className={styles.divider} />
        <button className={styles.iconBtn} onClick={togglePalette} title="Node Palette (Ctrl+P)">
          <PlusIcon />
        </button>
        <input
          ref={fileInputRef}
