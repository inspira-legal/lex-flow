...
export function DragPreview() {
  ...
  useEffect(() => {
    ...
    const handleMouseUp = (e: MouseEvent) => {
      ...
      console.log('[DragPreview] mouseUp target:', target.tagName, target.className)
      const isOverCanvas =
        target.closest('svg') !== null || target.closest('[class*="canvas"]') !== null
      console.log('[DragPreview] isOverCanvas:', isOverCanvas, 'draggingOpcode:', draggingOpcode?.name)
