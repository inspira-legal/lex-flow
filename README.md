...
2. **Run a workflow**: `python main.py tests/simple_hello.json`
3. **Test the system**: `python run_tests.py`
...
- **JSON-based workflows** - Human-readable, tooling-friendly format
