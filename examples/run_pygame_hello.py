#!/usr/bin/env python3
"""Run the pygame hello world workflow example."""
...
async def main():
    """Run the pygame hello world workflow."""
    workflow_path = Path(__file__).parent / "example_pygame_hello.yaml"

    print("=" * 60)
    print("LexFlow + Pygame Demo")
    print("=" * 60)
