...
- [📁 Google Drive](#google-drive) *(requires `lexflow[drive]`)*
...
### `http_post_data(url, data, headers=None, timeout=30.0)`
...
### `http_post_json(url, json, headers=None, timeout=30.0)`
...
> **Requires:** `pip install lexflow[drive]`

### `drive_create_client(credentials_path=None)`
...
### `drive_download_file_as_bytes(client, file_id)`
...
- `client` (Any, required)
- `file_id` (Any, required)

**Returns:** `Any`

---

### `drive_download_file_as_string(client, file_id, encoding="utf-8")`
...
- `client` (Any, required)
- `file_id` (Any, required)
- `encoding` (Any, optional, default: `"utf-8"`)

**Returns:** `Any`

---

### `drive_export_document_as_pdf(client, file_id)`
...
### `drive_get_file_metadata(client, file_id)`
...
### `drive_get_folder_id_by_name(client, folder_name, parent_folder_id=None)`
...
- `client` (Any, required)
- `folder_name` (Any, required)
- `parent_folder_id` (Any, optional, default: `None`)

**Returns:** `Any`

---

### `drive_list_files(client, folder_id=None, query=None, max_results=100)`
...
- `client` (Any, required)
- `folder_id` (Any, optional, default: `None`)
- `query` (Any, optional, default: `None`)
- `max_results` (Any, optional, default: `100`)

**Returns:** `Any`

---

### `drive_list_folders(client, parent_folder_id=None)`
...
### `drive_read_document(client, file_id)`
...
### `drive_search_files(client, name_contains, folder_id=None, mime_type=None, max_results=50)`
...
- `client` (Any, required)
- `name_contains` (Any, required)
- `folder_id` (Any, optional, default: `None`)
- `mime_type` (Any, optional, default: `None`)
- `max_results` (Any, optional, default: `50`)
